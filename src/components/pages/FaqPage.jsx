...
const FaqPage = () => {
    return (
        <main>
            <TitleSEO
                title="GMM | FAQ"
                description="Encuentra respuestas claras y rápidas a las dudas más comunes sobre el seguro de Gastos Medicos Mayores 2025."
                canonical="https://gastosmedicosmayores.com.mx/faq"
            />
            ...
            <section className={styles.sectionContainer}>
                <div className="fade-in">
                    <header className={styles.sectionTitulo}>
                        ...
                        <h2 className="light-text">Gastos Medicos Mayores</h2>
                    </header>
